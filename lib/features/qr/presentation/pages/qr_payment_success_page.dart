...
class QRPaymentSuccessPage extends StatefulWidget {
  const QRPaymentSuccessPage({super.key});
  @override
  State<QRPaymentSuccessPage> createState() => _QRPaymentSuccessPageState();
}
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                      ...
                      children: [
                        ...
                        FittedBox(
                          ...
                          child: Text(
                            'PKR, 250000',
                            style: TextStyle(
                              fontSize: AppResponsive.fs(36, max: 42),
                              fontWeight: FontWeight.bold,
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _DetailRow('Transaction ID', 'TXN9986485331'),
                        Divider(
                          height: AppResponsive.h(20),
                          color: const Color(0xffF0F0F0),
                        ),
                        _DetailRow('Date & Time', 'Oct 9, 2025 at 12:08 PM'),
                        Divider(
                          height: AppResponsive.h(20),
                          color: const Color(0xffF0F0F0),
                        ),
                        _DetailRow('Payment Method', 'QR Code Scan'),
                      ],
                    ),
                  ),
                ),
              ...
              // ── Share / Download buttons — Expanded, no overflow ───────
              FadeTransition(
                opacity: _contentFade,
                child: SlideTransition(
                  position: _contentSlide,
